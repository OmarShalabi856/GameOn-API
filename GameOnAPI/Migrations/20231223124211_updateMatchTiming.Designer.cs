...
namespace GameOnAPI.Migrations
{
    ...
    [Migration("20231223124211_updateMatchTiming")]
    partial class updateMatchTiming
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameOnAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "324u3943583404",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2e30a448-0220-44a0-bdb4-a2839133c939",
                            ...
                            SecurityStamp = "4eae2c87-c709-41fa-9895-f6f232ac1700",
                        ...
                        new
                        {
                            Id = "32ewdewd83404",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6c5f6701-24b3-4c8e-84ad-0e08327954d6",
                            ...
                            SecurityStamp = "2dbd8698-f4f4-48a7-936f-531fa953ac8e",
                            TwoFactorEnabled = false,
                            UserName = "Ali",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "138ba8b2-e42d-4b0c-8534-85b520926236",
                            ...
                            SecurityStamp = "c878cdf6-9251-4ddb-8460-3e6e831eb098",
                            TwoFactorEnabled = false,
                            UserName = "Omar",
                            Weight = 68.5,
                            experienceLevel = 2,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c906aa5b-f59a-4029-8ee8-916f7ab2a011",
                            Email = "user3@example.com",
                            EmailConfirmed = false,
                            FavoriteTeam = "Napoli",
                            Height = 172.0,
                            ...
                            SecurityStamp = "6e8dc861-c3f9-4ac0-b625-b1f9f891c2f5",
                            TwoFactorEnabled = false,
                            UserName = "Hussein",
                            Weight = 68.5,
                            experienceLevel = 2,
            ...
            modelBuilder.Entity("Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeadlineRequestsDateTime = new DateTime(2024, 1, 5, 2, 42, 11, 236, DateTimeKind.Local).AddTicks(6536),
                            EndDateTime = new DateTime(2023, 12, 25, 17, 42, 11, 236, DateTimeKind.Local).AddTicks(6529),
                            Featured = true,
                            FieldId = 3,
                            PlayerCount = 8,
                            StartDateTime = new DateTime(2023, 12, 25, 14, 42, 11, 236, DateTimeKind.Local).AddTicks(6474),
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreationDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeadlineRequestsDateTime = new DateTime(2023, 12, 31, 22, 42, 11, 236, DateTimeKind.Local).AddTicks(6553),
                            EndDateTime = new DateTime(2023, 12, 26, 16, 42, 11, 236, DateTimeKind.Local).AddTicks(6549),
                            Featured = true,
                            FieldId = 2,
                            PlayerCount = 12,
                            StartDateTime = new DateTime(2023, 12, 26, 14, 42, 11, 236, DateTimeKind.Local).AddTicks(6545),
                            UserId = 1
                        },
                        new
                        {
                            Id = 1,
                            CreationDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeadlineRequestsDateTime = new DateTime(2023, 12, 28, 14, 42, 11, 236, DateTimeKind.Local).AddTicks(6568),
                            EndDateTime = new DateTime(2023, 12, 27, 16, 42, 11, 236, DateTimeKind.Local).AddTicks(6564),
                            Featured = true,
                            FieldId = 1,
                            PlayerCount = 16,
                            StartDateTime = new DateTime(2023, 12, 27, 14, 42, 11, 236, DateTimeKind.Local).AddTicks(6559),
                            UserId = 1
                        });
                });
